        ...
        <aside className='bg-white sm:w-[20%] w-full h-fit sm:h-[100vh] shadow-md shadow-slate-300 pt-5'>
                <div className='flex justify-center items-center flex-col'>
                    <div className='text-5xl cursor-pointer relative flex justify-center'>
                        ...
                        userdetails?.userImage ? (
                            <img src={userdetails?.userImage} className='w-20 h-20 rounded-full border-[3px] border-red-500' alt={userdetails?.name} />
                        ) : (
                            <FaRegCircleUser/>
                        )
                        }
                ...
                <div>   
                    <nav className='grid p-4'>
                        <Link to={"/admin/allusers"} className='px-4 py-1 hover:bg-slate-100'>All Users</Link>
                        <Link to={"/admin/allProduct"} className='px-4 py-1 hover:bg-slate-100'>All product</Link>
                    </nav>
                </div>  
        </aside>
