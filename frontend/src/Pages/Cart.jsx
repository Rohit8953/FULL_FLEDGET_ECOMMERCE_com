...
const Cart = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/addtocartproduct`,
  ...
  const increaseQty = async (id, qty) => {
    try {
        const response = await axios.post(
          `${process.env.REACT_APP_API_URL}/countupdate`,
          {
            productId: id,
            quantity: qty + 1,
          },
  ...
  const deleteCartProduct = async (id) => {
    try {
        const response = await axios.post(
          `${process.env.REACT_APP_API_URL}/deleteaddtocartproduct`,
          { _id: id },
          {withCredentials:true}
        );
        if (response.data.success) {
  ...
  const makepayments = async () => {
    ...
    const stripe = await loadStripe(
      "pk_test_51Ph7haRxahYVGxLcvVOKSiOEL1bVwPrZhqKfnM46GUv4f6C38qagplHiwBYMPxiinxFb12xjSy9Vwk2GtvQOlRuO00mzbRK2eO"
    );
              ...
              <div class="p-6 md:mx-auto">
                ...
                <div class="text-center">
                  ...
                  <p class="text-gray-600 my-2">
                    There is not any card that you have added...
                  </p>
            ...
            {loading ? (
              ...
              <div className="h-36 bg-white">
                ...
                <button
                  ...
                  className="bg-blue-600 p-2 text-white w-full mt-2 flex gap-1 items-center justify-center"
                >
